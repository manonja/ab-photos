export const getComplementaryText = (slug: string): string => {
  ...
  if (slug === '7-rad') {
    complementaryText =
      'My curiosity led me to analyze NASA/NOAA VIIRS satellite data, through which I found that the Netherlands produces some of the highest levels of artificial light at night (ALAN) globally, far exceeding averages seen in other OECD countries. This discovery inspired me to capture the intricate interplay of light and darkness within urban settings, framing the grandeur of modern life alongside the complex relationship between human constructs and the natural world.'
