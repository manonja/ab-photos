export const getComplementaryText = (slug: string): string => {
  ...
  if (slug === '7-rad') {
    complementaryText =
      'To make these photographs, I stopped looking for landscape and started looking at data, patterns that hinted at human optimization. Satellites record how much artificial light reaches space from each patch of ground every night; that measurement is called radiance, or Rad, and gives the project its title. I used renderings of this data as a compass, letting the brightest points on the map decide where I pointed my camera rather than choosing a view first. Today the Milky Way can reliably be seen from one island in the northern Netherlands, and I sometimes wonder whether the children cycling past these greenhouses will ever learn to find it.'
