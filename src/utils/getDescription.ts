export const getDescription = (slug: string): string => {
  ...
  if (slug === '7-rad') {
    description =
      '"When I think of the starry night, I think of a vacation in France." A cyclist in the Westland said this to me — the region locals call the Glass City, whose greenhouses help make the Netherlands the world\'s second-largest agricultural exporter. I moved back to the Netherlands in 2020, after a mentorship with Magnum Photos and years photographing in New York and São Paulo, and it was the countryside, not any city, that struck me as impossibly bright at night. This is a nation that has spent centuries engineering its land against water, diking and draining field by field; I found that same instinct for optimization now aimed at the night itself, keeping greenhouses lit through the winter dark. 7 Rad is my attempt to look directly at that light.'
