export const getDescription = (slug: string): string => {
  ...
  if (slug === '7-rad') {
    ...
    description =
      'In 2018 I knew Secunda only as data: I wrote algorithms to predict failures in the cooling systems of the Sasol plant, a facility that turns coal into liquid fuel. The Fischer–Tropsch process it runs on was industrialized in Germany in the 1930s; South Africa had used it since the 1950s, and Secunda itself was built between 1976 and 1982, when oil embargoes cut the country off from imported crude. The site releases fifty-six megatons of carbon dioxide a year, more than any other single site on Earth, of the sixty-four megatons its group reports. In 2024 I came back with medium and large format cameras to see it: the plant, the Highveld grassland around it, and the people who live in Secunda and Embalenhle, within sight of the works. The coal seams are finite; Sasol puts the plant’s useful life at 2050. These photographs are of a place still at work.'
