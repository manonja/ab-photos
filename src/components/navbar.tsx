...
export default function Navbar({ workDropdown }: NavbarProps) {
  ...
  return (
    <div className="z-10 w-full px-6 items-center justify-between text-sm lg:flex">
      <Link
        className="text-3xl lg:text-6xl font-anton left-0 top-0 flex w-full justify-center p-3 lg:p-6 lg:static lg:w-auto"
        href="/"
      ...
      <div
        className={`fixed items-center lg:pb-6 pb-2 bottom-0 gap-2 lg:gap-4 left-0 flex flex-row h-auto w-full lg:items-end justify-center bg-gradient-to-t from-black via-black lg:static lg:h-auto lg:w-auto lg:bg-none transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="flex flex-row gap-3 lg:gap-4">
          ...
          <Link
            className="flex place-items-center gap-2 px-1 py-2 pointer-events-auto lg:px-0 lg:py-0 hover:border-b focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white lg:focus-visible:ring-offset-2 uppercase"
            href="/exhibitions"
        ...
        <div className="flex flex-row pl-1 lg:pl-6 gap-2 lg:gap-4">
          <a
            href="https://www.instagram.com/anton__photography"
            className="text-xs text-neutral-600 flex place-items-center gap-2 p-2 pointer-events-auto lg:p-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white lg:focus-visible:ring-offset-2"
            target="_blank"
          ...
          <a
            ...
            className="text-xs text-neutral-600 flex place-items-center p-2 pointer-events-auto lg:p-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white lg:focus-visible:ring-offset-2"
            target="_blank"
            rel="noopener noreferrer"
