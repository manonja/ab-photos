...
export const exhibits: Exhibit[] = [
  ...
  },
  {
    ...
    description:
      "Finalists of the Critical Eye Photography Awards 2025 with the portrait 'Lady in onesie Pyjama, Embalenhle'. The exhibition showcase the finalists' portraits from the street.",
  ...
  },
  {
    ...
    description:
      'FOTOFILMIC is proud to present the final 11 photographic projects developed during its 2024-25 Annual FotoFilmic Mentoring Program (AFMP) that was led by core mentors Elisa Medde (IT/NL), Stacy Kranitz (USA), and Christian Patterson (USA).',
