/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: 63a9fd8f4278ac4f1f3f5d56434dee15)
// Runtime types generated with workerd@1.20251210.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_API_URL: string;
		DIRECT_URL: string;
		DATABASE_URL: string;
		NEXT_PUBLIC_MAILCHIMP_AUDIENCE_ID: string;
		NEXT_PUBLIC_MAILCHIMP_API_KEY: string;
		NEXT_PUBLIC_MAILCHIMP_API_SERVER: string;
		NEXT_PUBLIC_MAILCHIMP_URL: string;
		NEXT_PUBLIC_CONTACT_FORM_URL: string;
		NEXT_PUBLIC_GHOST_URL: string;
		NEXT_PUBLIC_GHOST_CONTENT_API_KEY: string;
